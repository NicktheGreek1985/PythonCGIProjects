def createQueries(in_name, out_name, table):
  file_in = open("RawData/" + in_name, 'rU')
...
in_files = ["City.csv", "Continent.csv", "Country.csv", "encompasses.csv", "EthnicGroup.csv", "Language.csv", "Population.csv"]

# These are the tables that each csv file corresponds to
tables = ["City", "Continent", "Country", "encompasses", "EthnicGroup", "Language", "Population"]

# The name of the database
database = "theworld.db"

# The name of the python file that you will create
out_file = "qry2_insert_data.py"
#
##############################
