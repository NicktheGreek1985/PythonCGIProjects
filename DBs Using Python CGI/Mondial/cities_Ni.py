...
#
print('<h1>Cities of Ni</h1>')
print('<p>The following table lists the cities that start with "Ni".</p>')
#
#####
...
#
cursor.execute('SELECT name, country, population FROM City WHERE name LIKE "Ni%"')
