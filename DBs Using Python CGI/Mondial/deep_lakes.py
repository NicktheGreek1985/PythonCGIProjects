...
#
print('<h1>Deepest Lakes</h1>')
print('<p>The following table lists the deepest lakes.</p>')
#
#####
...
#
cursor.execute('SELECT name, area, depth, altitude FROM Lake ORDER BY depth DESC LIMIT 15')
...
fields = ["Name", "Area", 'Depth', 'Elevation']
#
