...
#
print('<h1>Language Groups</h1>')
print('<p>The following table lists the name and count for each language.</p>')
#
#####
...
#
cursor.execute('SELECT name, percentage FROM Language GROUP BY percentage ORDER BY percentage DESC')
