...
#
print('<h1>Long Rivers</h1>')
print('<p>The following table lists the rivers in descending order of length.</p>')
#
#####
...
#
cursor.execute('SELECT name, length FROM River ORDER BY length DESC')
