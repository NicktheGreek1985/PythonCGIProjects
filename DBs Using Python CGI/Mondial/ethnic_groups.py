...
#
print('<h1>Ethnic Groups</h1>')
print('<p>The following table lists the name and percentage for each ethnic group.</p>')
#
#####
...
#
cursor.execute('SELECT name, percentage FROM EthnicGroup')
