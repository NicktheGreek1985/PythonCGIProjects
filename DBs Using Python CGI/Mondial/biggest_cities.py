...
#
print('<h1>Most People</h1>')
print('<p>The following table lists the 20 most populated countries.</p>')
#
#####
...
#
cursor.execute('SELECT name, capital, area, population FROM Country ORDER BY population DESC LIMIT 20')
