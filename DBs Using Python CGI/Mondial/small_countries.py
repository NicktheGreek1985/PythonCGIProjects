...
#
print('<h1>Small Countries</h1>')
print('<p>The following table lists the countries with a population smaller than 10,000.</p>')
#
#####
...
#
cursor.execute('SELECT name, capital, area, population FROM Country WHERE population < 10000')
