...
#
print('<h1>Cites of the Nile</h1>')
print('<p>The following table lists the cities on the nile.</p>')
#
#####
...
#
cursor.execute('SELECT city, province, country FROM Located WHERE river = "Nile"')
