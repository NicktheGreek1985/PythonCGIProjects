...
#
print('<h1>Small Islands</h1>')
print('<p>The following table lists the islands smaller than 100 square metres.</p>')
#
#####
...
#
cursor.execute('SELECT name, area FROM Island WHERE area < 100 ORDER BY area')
