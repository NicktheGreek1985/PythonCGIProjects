...
#
print('<h1>Averaging Out</h1>')
print('<p>The following table lists the average area and average population of the countries.</p>')
#
#####
...
#
cursor.execute('SELECT AVG(area), AVG(population) FROM Country')
