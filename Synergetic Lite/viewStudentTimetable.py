...
viewStudentTimetable.py

Creates HTML page to display the timetable for a student.
...
print('</div>')
print('<a href="studentsManage.py"><div class="backButton">Back</div></a>')
print('<hr>')
